...
export default function ExperienceSection() {
  return (
    <div className={`${inter.className} max-w-[1440px] gap-y-10 mt-24 pb-30 px-10 flex flex-row flex-wrap justify-center gap-x-[20px]`}>
      <div className="flex max-w-[700px] gap-5">
        <div className="w-2 h-full rounded-full bg-[#574FE4]"/>

        <div className="py-3 w-full gap-y-12 gap-x-5 flex  flex-row max-[840px]:flex-col  min-[1240px]:flex-col">  
           <div className="">
      ...
      <div className="flex overflow-hidden flex-wrap flex-col gap-7 max-w-[700px]">
        <div className="flex w-full items-center max-[840px]:flex-col flex-row justify-center gap-[19px]">
          
          <SoftSkills/>
          
          <div className="relative min-[840px]:w-[340px] w-full overflow-hidden">
            <div className="bg-[#101010] p-[7%] w-[35%] -top-5 left-4 rounded-full absolute">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-full"  viewBox="0 0 26 26" fill="none">
