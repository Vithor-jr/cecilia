			...
			<div className="flex gap-y-10 flex-col	xl:flex-row justify-between flex-wrap">
				...
				<div className="flex flex-row flex-wrap">
					<h1 className={`${inter.className} leading-[58px] font-bold text-[45px]`}>Vamos construir</h1>
						...
						<h1 className={`${inter.className} leading-[58px] flex flex-row gap-1 font-bold text-[45px]`}>
							sua presença 
							<Image
								src={ceci}
								alt="ceci"
					...
					<h1 className={`${inter.className} leading-[58px] font-bold text-[45px]`}>digital e física</h1>
					<h1 className={`${inter.className} bg-[#574FE4] w-[165px] h-[58px] rounded-2xl text-center text-white leading-[58px] font-bold text-[45px]`}>juntos</h1>
				</div>
				...
				<div className={`${inter.className} flex-wrap gap-3 flex flex-row`}>
					<div className="text-white flex overflow-hidden relative w-full h-[480px] rounded-[30px] min-[450px]:w-[280px] bg-[#101010]">
					...
					<div className="relative w-full h-[480px] rounded-[30px] min-[450px]:w-[280px] bg-[#DDDDDD]">
						<div className="w-full absolute pl-5 pr-6 mt-[35px] items-center z-10 flex justify-between">
					...
					<div className="text-white relative w-full h-[480px] rounded-[30px] min-[450px]:w-[280px] bg-[#574FE4]">
						<div className="w-full absolute pl-5 pr-6 mt-[35px] items-center z-10 flex justify-between">
			...
			<div className={`${inter.className} justify-between w-full flex flex-wrap flex-row mt-20 px-10 py-18 bg-[#101010] rounded-[30px] text-white`}>
				<div className="flex flex-col min-h-[471px] max-w-[460px]">
					<div className="flex flex-row items-center gap-2">
						...
						<div className="w-13 h-13 bg-[#574FE4] flex justify-center items-center rounded-full">
							<svg xmlns="http://www.w3.org/2000/svg" width="18" height="15" viewBox="0 0 18 15" fill="none">
					...
					<p className="font-light text-[22px]">O diferencial está em como cada decisão é guiada por método, intenção e clareza de marca.</p>
					
					<div className="flex items-end bg-[#DDDDDD] mt-5	min-h-[287px] px-6 pt-8 rounded-[30px] flex-col text-black">
						<Image
							src={ceci_2}
							alt="ceci"
						/>

						<div className="mt-20 flex gap-1 w-full flex-row items-center">
							<p className="bg-[#101010] rounded-full w-7 h-7 flex items-center justify-center text-[#574FE4] text-[16px]">1</p>
							<p className="text-black font-bold text-[24px]">Estratégia antes da estética</p>
						</div>
				...
				<div className={`${inter.className} px-5 pb-13 relative flex flex-col justify-end max-w-[350px] overflow-hidden w-full rounded-[30px] bg-[#574FE4] h-[471px]`}>
					...
					<div className="mt-20 mb-1 flex gap-1 w-full flex-row items-center">
						<p className="bg-white rounded-full w-7 h-7 flex items-center justify-center text-[#574FE4] text-[16px]">2</p>
						<p className="text-whilefont-bold text-[20px]">Design orientado a resultado</p>
					</div>
				...
				<div className="flex flex-col justify-between gap-2">
					<div className="flex flex-col rounded-[30px] w-full max-w-[350px] relative bg-[#9FDE8D] min-h-[224px]">
						...
						<div className="mt-30 mx-5 mb-1 flex gap-1 w-full flex-row items-center">
							<p className="bg-[#101010] rounded-full w-7 h-7 flex items-center justify-center text-[#574FE4] text-[16px]">3</p>
							<p className="text-[#101010] font-bold text-[20px]">Metodologia exclusiva</p>
						</div>

						<p className={`${inter.className} mx-5 text-[#101010] text-[13px]`}>Processo próprio que garante decisões guiadas por método, intenção e resultado.</p>
			
					</div>

					<div className="flex flex-col rounded-[30px] w-full max-w-[350px] relative bg-[#92D1E0] min-h-[224px]">
						...
						<div className="mt-30 mx-5 mb-1 flex gap-1 w-full flex-row items-center">
							<p className="bg-[#101010] rounded-full w-7 h-7 flex items-center justify-center text-[#574FE4] text-[16px]">4</p>
							<p className="text-[#101010] font-bold text-[20px]">Posicionamento digital 360°</p>
						</div>

						<p className={`${inter.className} mx-5 text-[#101010] text-[13px]`}>Entregas completas, do conceito visual ao alinhamento estratégico da marca.</p>
					</div>
				</div>
			</div>
		</section>
