...
export default function Hardskills() {
	return (
		<div className="flex w-full md:h-[280px] rounded-[30px] flex-col justify-between">
				<div className="w-full relative pl-7 pr-5 items-center flex h-[55%] bg-[#574FE4] overflow-hidden rounded-t-2xl md:rounded-bl-2xl">
					<h1 className={`${poppins.className} text-white font-bold text-[20px] absolute top-7 right-5`}>Hard Skills</h1>

					<div className="flex flex-col w-full gap-2 mb-15 md:mt-14 mt-24">
				...
				<div className="flex h-[45%] flex-col md:flex-row-reverse w-full">
					...
					<div className="flex flex-1/3 relative">
						<div className="md:flex hidden bg-[#574FE4] w-10 h-10 absolute top-0 right-0 z-0"/>
