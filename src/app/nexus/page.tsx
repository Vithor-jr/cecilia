...
import evolucao from '../../assets/nexus/evolucao.png'
import main from '../../assets/nexus/main.png'
import nxs1 from '../../assets/nexus/nxs_1.png'
import nxs2 from '../../assets/nexus/nxs_2.png'
import nxs1_2 from '../../assets/nexus/nxs_1_2.png'
import nxs2_2 from '../../assets/nexus/nxs_2_2.png'
import colors from '../../assets/nexus/colors.png'
		...
		<div className="flex bg-[#F0F0F0] flex-col items-center justify-center  pt-20">
			<div className="w-[90vw] max-w-[1000px] pb-10  gap-4">
				<Header
					...
					description="Aplicativo para aprimoramento de softskills - habilidade sociais."
				/>
				...
				<div className="flex mt-10 flex-col  mb-5  md:flex-row flex-wrap gap-5">
					<Section
						...
						number={1}
						description="O Nexus Skill nasceu para democratizar o desenvolvimento de soft skills entre jovens. O desafio era criar uma marca jovem, acessível e tecnológica, que transmitisse confiança sem perder leveza."
					/>
					...
					<Section
						...
						number={2}
						description="O público-alvo são jovens entre 14 e 29 anos que desejam se desenvolver e crescer no próprio ritmo. Para inspiração e referência de engajamento, foram considerados aplicativos de educação e games digitais, reconhecidos por sua capacidade de cativar e motivar os usuários."
					/>
				</div>
					...
					<Section
						...
						isNexusThird
						number={3}
						description="A identidade se baseou em tecnologia, Inovação e evolução."
					/>
			</div>
			...
			<section className="bg-[#0B0B0B] pb-10 w-full">
				<div className="flex sm:flex-row flex-col">
					<div className="flex-1 relative w-full h-100">
						...
						/>
						<Image
							className="w-[65%] absolute z-2 left-[10%] top-[10%]"
							src={luz}
							alt="luz"
						/>
				...
				<div className="bg-[#0B0B0B] flex-col flex items-center justify-center py-[5vw] w-full">
					...
					<p className={`${inter.className} text-[16px] px-5 mt-5 md:text-[20px] text-[#6E6E6E] text-center font-bold`}>Clique para ver o manual de marca do Nexus skill</p>
					
					<a 
						href="/BrandNexus.pdf" 
						target="_blank" 
						rel="noopener noreferrer"
						className={`${inter.className} bg-[#01B3D7] text-[white] font-bold px-6 rounded-[6px] py-2 md:text-[20px] mt-5 text-[16px]`}>
						Ver manual de marca
					</a>
				</div>
			</section>
		...
		<div className="w-[90vw] max-w-[1000px] flex flex-col items-center pb-10  gap-4">
			<div className="flex mt-10 flex-col  mb-5  md:flex-row w-full flex-wrap gap-5">
					<Section
						...
						number={5}
						description="A nova identidade do Nexus Skill ganhou vida no app, na landing page e nas redes sociais. O design é jovem, tecnológico e acolhedor, transmitindo confiança e tornando o aprendizado de soft skills leve e envolvente."
					/>
					...
					<Section
						...
						number={6}
						description="A nova identidade tornou a marca mais clara e memorável, gerando maior conexão com o público jovem e fortalecendo o engajamento por meio da gamificação. O Nexus Skill deixou de ser apenas um app e se tornou um movimento de transformação pessoal."
					/>
				</div>
