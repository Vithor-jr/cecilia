...
import main from "../../../assets/nomadstudio/main.png"

import group from '../../../assets/nomadstudio/group.png'
import ns from '../../../assets/nomadstudio/ns.png'
import card from '../../../assets/nomadstudio/card.png'
import adesivos from '../../../assets/nomadstudio/adesivos.png'
import bolsa from '../../../assets/nomadstudio/bolsa.png'
import paleta from '../../../assets/nomadstudio/paleta.png'
		...
		<div className="flex border-0 bg bg-[#F0F0F0] flex-col items-center justify-center  pt-20">
			<div className="w-[90vw] max-w-[1000px] pb-10  gap-4">
				<Header
					...
					description="Identidade visual para ateliê de mobiliário artesanal."
				/>
				...
				<div className="flex mt-10 flex-col  mb-5  md:flex-row flex-wrap gap-5">
					<Section
						...
						number={1}
						description="A Nomad Studio é um estúdio de design que une a marcenaria tradicional ao olhar contemporâneo.A marca surgiu da ideia de que o lar é um espaço vivo, onde o tempo deixa marcas e a madeira carrega histórias. Cada peça é feita manualmente, com foco em durabilidade, conforto e autenticidade."
					/>
					...
					<Section
						...
						number={2}
						description="Durante o processo, foram estudadas referências de estúdios autorais que valorizam a produção artesanal e a estética natural. A proposta foi traduzir a essência da Nomad: o equilíbrio entre técnica e sensibilidade, com uma identidade visual simples, elegante e funcional."
					/>
				</div>
					...
					<Section
						...
						number={3}
						description="A identidade parte de três pilares: essência, movimento e atemporalidade.O design combina o calor da madeira com a leveza do espaço, inspirado no minimalismo escandinavo e nas formas orgânicas brasileiras. A paleta neutra e terrosa reforça a ideia de conexão com a natureza e com o tempo."
					/>
			</div>
			...
			<div className="flex relative bg-[#F4F4F4] w-full  flex-col sm:flex-row">
				<motion.div 
					...
					className="z-2">
					<Image
						className="sm:w-[calc(100vw*(681/1440))] w-full sm:h-[calc(100vw*(872/1440))] z-2"
						src={ns}
						alt="ns"
					/>
				</motion.div>
				...
				<motion.div 
					...
					className=" z-2">
					<Image
						className="sm:absolute h-full z-1 sm:w-[calc(100vw*(759/1440))] sm:h-[calc(100vw*(873/1440))] right-0"
						src={group}
						alt="group"
					/>
				</motion.div>
			...
			<div className="w-[90vw] max-w-[1000px]  mb-5 flex flex-col items-center pb-10  gap-4">
				<div className="flex mt-10 flex-col   md:flex-row w-full flex-wrap gap-5">
					<Section
						...
						number={5}
						description="O sistema visual comunica a personalidade do estúdio com clareza e sofisticação.As tipografias, texturas e composições refletem o toque humano da marcenaria e a precisão do design, criando uma marca sólida, calma e autêntica."
					/>
					...
					<Section
						...
						number={6}
						description="A Nomad Studio se consolidou como um ateliê que cria mais do que móveis, cria permanência.A nova identidade traduz o propósito da marca: transformar madeira e tempo em peças que acolhem."
					/>
				</div>
