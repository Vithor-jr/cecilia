...
import main from "../../assets/VEEG/main.png"

import cracha from '../../assets/VEEG/cracha.png'
import caneca from '../../assets/VEEG/caneca.png'
import predio from '../../assets/VEEG/predio.png'
import paleta from '../../assets/VEEG/paleta.png'
import banner from '../../assets/VEEG/banner.png'
import motorista from '../../assets/VEEG/motorista.png'
import camisa from '../../assets/VEEG/shirt.png'
import caminhao from '../../assets/VEEG/caminhao.png'

export default function VEEGPage(){
		...
		<div className="flex border-0 bg bg-[#F0F0F0] flex-col items-center justify-center  pt-20">
			<div className="w-[90vw] max-w-[1000px] pb-10  gap-4">
				<Header
					...
					description="Empresa de transporte de cargas secas com foco em confiança e profissionalismo."
				/>
				...
				<div className="flex mt-10 flex-col  mb-5  md:flex-row flex-wrap gap-5">
					<Section
						...
						number={1}
						description="A VEEG Transportes construiu uma reputação baseada em compromisso, responsabilidade e transparência. A criação da nova identidade visual surgiu como estratégia para reforçar a presença no setor logístico e transmitir a confiabilidade que sustenta a marca.	"
					/>
					...
					<Section
						...
						number={2}
						description="No segmento de transportes, marcas fortes e consistentes se destacam pela clareza e impacto visual. O estudo mostrou a necessidade de uma identidade que comunicasse movimento, modernidade e organização, sem perder a seriedade e credibilidade essenciais ao ramo logístico."
					/>
				</div>
			...
			<motion.div 
				...
				<Image
					src={caneca}
					className="absolute -bottom-[12%] w-[28%] right-0"
					alt="caneca"
				/>
			</motion.div>
			...
			<motion.div 
				...
				<Image
					src={cracha}
					className="absolute -bottom-[15%] w-[35%] left-0"
					alt="cracha"
				/>
			</motion.div>
			...
			<div className="flex relative bg-[#F4F4F4] w-full  flex-col sm:flex-row">
				<motion.div 
					...
					className="z-2">
					<Image
						className="sm:w-[calc(100vw*(661/1440))] w-full sm:h-[calc(100vw*(611/1440))] z-2"
						src={camisa}
						alt="camisa"
					/>
				...
				<motion.div 
					...
					className="z-10 ">
					<Image
						className="w-[60%] absolute right-[10%] bottom-0"
						src={caminhao}
						alt="caminhao"
					/>
				</motion.div>
				...
				<motion.div 
					...
					className=" z-2">
					<Image
						className="sm:absolute h-full z-1 sm:w-[calc(100vw*(779/1440))] sm:h-[calc(100vw*(611/1440))] right-0"
						src={motorista}
						alt="motorista"
					/>
				</motion.div>
			...
			<div className="w-[90vw] max-w-[1000px]  mb-5 flex flex-col items-center pb-10  gap-4">
				<div className="flex mt-10 flex-col   md:flex-row w-full flex-wrap gap-5">
					<Section
						...
						number={5}
						description="A nova identidade da VEEG reforça o posicionamento da empresa como uma marca impactante, organizada e confiável, traduzindo seus valores em uma estética clara, moderna e marcante."
					/>
					...
					<Section
						...
						number={6}
						description="A identidade conecta a marca aos seus pilares e fortalece sua competitividade, resultando em +15% no reconhecimento no setor logístico."
					/>
				</div>
