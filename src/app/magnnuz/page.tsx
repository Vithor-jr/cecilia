...
import banner from '../../assets/magnnuz/mag_banner.png'
import { inter } from "../fonts"
import pense from '../../assets/magnnuz/pense_grande.png'
import main from "../../assets/magnnuz/main.png"
import cria from '../../assets/magnnuz/cria.png'
import shirt from '../../assets/magnnuz/shirt.png'
import acessorios from '../../assets/magnnuz/acessorios.png'
import caneca from '../../assets/magnnuz/caneca.png'

export default function MagnnuzPage() {
		...
		<div className="flex border-0 bg bg-[#F0F0F0] flex-col items-center justify-center  pt-20">
			<div className="w-[90vw] max-w-[1000px] pb-10  gap-4">
				<Header
					...
					description="Dispositivo interativo para aprendizado e prática do xadrez."
				/>
				...
				<div className="flex mt-10 flex-col  mb-5  md:flex-row flex-wrap gap-5">
					<Section
						...
						number={1}
						description="O xadrez é um dos jogos mais antigos do mundo, mas ainda desafia muitos iniciantes pela complexidade de seus movimentos. O Magnnuz surge como uma solução inovadora que une tradição e tecnologia, tornando o aprendizado mais acessível e intuitivo para crianças e adolescentes.	"
					/>
					...
					<Section
						...
						number={2}
						description="O dispositivo foi pensado para integrar hardware e tabuleiro físico, criando uma experiência imersiva. Cada movimento é acompanhado de LEDs que mostram as possibilidades de jogada, tornando o aprendizado mais rápido, visual e envolvente. Isso garante compreensão prática das regras e incentiva a permanência dos jovens no jogo."
					/>
				</div>
					...
					<Section
						...
						number={3}
						description="O Magnnuz é tecnologia com propósito: facilitar o aprendizado do xadrez de forma elegante e minimalista. A marca deve transmitir inovação, sofisticação e acolhimento, conectando-se ao público jovem sem perder a essência clássica do jogo. O símbolo central pode explorar o Rei ou sua coroa, aliado à inicial “M”, para criar uma identidade forte, versátil e memorável."
					/>
			</div>
			...
			<div className="flex bg-[#F4F4F4] w-full  flex-col sm:flex-row">
				<motion.div 
					initial={{ opacity:0.5}}
					animate={{ opacity:1}}
					transition={{duration:1, delay:0.2}}
					className=" z-2">
					<Image
						className="sm:w-[calc(100vw*(661.24/1440))] w-full sm:h-[calc(100vw*(698.93/1440))] z-2"
						src={mag_1}
						alt="magnuzz_1"
					/>
				...
				<motion.div 
					...
					className=" z-2">
					<Image
						className="sm:absolute h-full z-1 sm:w-[calc(100vw*(779/1440))] sm:h-[calc(100vw*(700/1440))] right-0"
						src={mag_2}
						alt="magnuuz"
					/>
				</motion.div>
			...
			<div className="flex bg-[#F4F4F4] z-10  w-full  flex-col sm:flex-row">
				<motion.div 
					initial={{ opacity:0.5}}
					animate={{ opacity:1}}
					transition={{duration:1, delay:0.2}}
					...
					<Image
						className="sm:w-[calc(100vw*(816/1440))] w-full sm:h-[calc(100vw*(805/1440))] z-2"
						src={cria}
						alt="crianca"
					/>

					<Image
						className="absolute left-0 z-2 -top-[20%] w-[50%]"
						src={acessorios}
						alt="acessorios"
					/>

					<Image
						className="absolute sm:-bottom-[20%] -bottom-[50%] z-10 right-0 sm:-right-[33%]"
						src={caneca}
						alt="caneca"
					/>
				</motion.div>
				...
				<motion.div 
					...
					className="flex ">
					<Image
						className="sm:absolute h-full z-1 sm:w-[calc(100vw*(624/1440))] sm:h-[calc(100vw*(805/1440))] right-0"
						src={shirt}
						alt="shirt"
					/>
				</motion.div>
			...
			<div className="w-[90vw] max-w-[1000px]  mb-5 flex flex-col items-center pb-10  gap-4">
				<div className="flex mt-10 flex-col   md:flex-row w-full flex-wrap gap-5">
					<Section
						...
						number={5}
						description="O Magnnuz entrega um dispositivo acessível, intuitivo e marcante, que transforma o processo de aprender xadrez em uma experiência clara e estimulante."
					/>
					...
					<Section
						...
						number={6}
						description="Mais do que ensinar movimentos, o Magnnuz desperta interesse pelo xadrez, estimula o raciocínio lógico e aproxima crianças e adolescentes de um universo estratégico que desenvolve concentração, paciência e inteligência emocional."
					/>
				</div>
