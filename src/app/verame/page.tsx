...
import main from "../../assets/verame/main.png"

import logotipo from '../../assets/verame/logotipo.png'
import paleta from '../../assets/verame/paleta.png'
import drink from '../../assets/verame/drink.png'
import drink2 from '../../assets/verame/drink_2.png'
import verame from '../../assets/verame/verame.png'
import pano from '../../assets/verame/pano.png'
import drink3 from '../../assets/verame/drink_3.png'

export default function VeramePage(){
		...
		<div className="flex border-0 bg bg-[#F0F0F0] flex-col items-center justify-center  pt-20">
			<div className="w-[90vw] max-w-[1000px] pb-10  gap-4">
				<Header
					...
					description="Um restaurante noturno de cozinha contemporânea, onde a noite é servida com elegância, presença e jazz."
				/>
				...
				<div className="flex mt-10 flex-col  mb-5  md:flex-row flex-wrap gap-5">
					<Section
						...
						number={1}
						description="A Vèrame nasceu do desejo de criar um refúgio noturno para quem busca viver o agora com calma e sofisticação.Mais do que um restaurante, é um espaço com o objetivo de desacelerar, entre taças, luz baixa e conversas que duram o tempo certo."
					/>
					...
					<Section
						...
						number={2}
						description="Durante o processo, foram analisadas referências de restaurantes autorais e experiências gastronômicas que unem estética e acolhimento. A partir disso, o foco foi criar uma identidade que transmitisse sofisticação sem parecer distante, elegante, mas próxima e autêntica."
					/>
				</div>
					...
					<Section
						...
						number={3}
						description="A identidade da Vèrame parte de três ideias principais: sensualidade, sofisticação e atmosfera. As cores, tipografias e composições refletem o clima da noite, luz suave, vinho, madeira escura e a sensação de estar em um lugar especial."
					/>
			</div>
			...
			<motion.div 
				...
				<Image
					className="w-[20%] min-w-[100px] z-10 -bottom-[15%] right-[10%] absolute"
					src={drink3}
					alt="drink_3"
				/>
			</motion.div>

			<div className="flex relative bg-[#F4F4F4] z-10 w-full flex-col sm:flex-row">
				<motion.div 
					initial={{ opacity:0.5}}
					animate={{ opacity:1}}
					transition={{duration:1, delay:0.2}}
					className="z-20">
					<Image
						className="sm:w-[calc(100vw*(595/1440))] w-full sm:h-[calc(100vw*(750/1440))] z-2"
						src={paleta}
						alt="paleta"
					/>

					<Image
						className="sm:w-[calc(100vw*(673/1440))] w-full sm:h-[calc(100vw*(92	/1440))] z-2"
						src={drink}
						alt="drink"
					/>
				...
				<motion.div 
					...
					className="z-10 flex flex-col items-end sm:absolute right-0 ">
					<Image
						className="w-full z-1 sm:w-[calc(100vw*(845/1440))] sm:h-[calc(100vw*(892/1440))] right-0"
						src={logotipo}
						alt="logotipo"
					/>

					<Image
						className="w-full sm:w-[calc(100vw*(767/1440))] sm:h-[calc(100vw*(721/1440))] bottom-0 right-0"
						src={drink2}
						alt="drink2"
					/>
				</motion.div>
			...
			<motion.div 
				...
				animate={{ opacity:1}}
				transition={{duration:1, delay:0.6}}
				className="z-10 flex flex-col sm:flex-row relative w-full">
				<Image
					className="w-full z-1 sm:w-[calc(100vw*(673/1440))] sm:h-[calc(100vw*(729/1440))] right-0"
					src={verame}
					alt="verame"
				/>

				<Image
					className="sm:absolute w-full sm:w-[calc(100vw*(789/1440))] sm:h-[calc(100vw*(811/1440))] bottom-0 right-0"
					src={pano}
					alt="pano"
				/>
			</motion.div>
			...
			<div className="w-[90vw] max-w-[1000px]  mb-5 flex flex-col items-center pb-10  gap-4">
				<div className="flex mt-10 flex-col   md:flex-row w-full flex-wrap gap-5">
					<Section
						...
						number={5}
						description="O resultado é uma marca sólida e coerente com a proposta do restaurante. A identidade visual reforça o caráter intimista e contemporâneo do espaço, ajudando a criar uma experiência que vai além do prato e conecta estética, sabor e emoção."
					/>
					...
					<Section
						...
						number={6}
						description="A Vèrame se consolidou como um restaurante que valoriza a presença. Cada detalhe, da fachada ao cardápio, reforça a sensação de estar em um ambiente pensado para viver o momento, com leveza e autenticidade."
					/>
				</div>
